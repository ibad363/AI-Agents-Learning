...
def main():
    ...
    # result = Runner.run_sync(agent_basic, "Hello!",run_config=config)
    ...
    # result1 = Runner.run_sync(agent_context, "Hello!",run_config=config)
    # print("First message:")
    # print(result1.final_output)
    
    # result2 = Runner.run_sync(agent_context, "Tell me about Python",run_config=config)
    # print("\nSecond message:")
    ...
    # result = Runner.run_sync(agent_time, "How are you today?",run_config=config)
    ...
    result = Runner.run_sync(agent_explorer, "What can you tell me about yourself?",run_config=config)
